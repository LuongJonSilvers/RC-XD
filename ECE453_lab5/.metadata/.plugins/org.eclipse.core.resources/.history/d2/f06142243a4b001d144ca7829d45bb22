...
void AT42QT2120_write_reg(uint8_t reg, uint8_t value)
{
	...
	cyhal_i2c_master_write(&i2c_master_obj, AT42QT2120_SUBORDINATE_ADDR, write_buffer[2], AT42QT2120_WRITE_PACKET_SIZE, 1, true );
...
uint8_t AT42QT2120_read_reg(uint8_t reg)
{
	...
	/* a restart condition. */
	cyhal_i2c_master_write(&i2c_master_obj, AT42QT2120_SUBORDINATE_ADDR, write_buffer, AT42QT2120_WRITE_PACKET_SIZE, 1, false );
	...
	cyhal_i2c_master_read(&i2c_master_obj, AT42QT2120_SUBORDINATE_ADDR, read_buffer, AT42QT2120_WRITE_PACKET_SIZE, 1, true );
	// Return the data
